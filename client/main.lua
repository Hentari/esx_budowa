...
local index = GetRandomIntInRange(1, #Config.Budowa)

for k, v in pairs(Config.Zones) do
  if v.Pos.x == Config.Budowa[index].x and v.Pos.y == Config.Budowa[index].y and v.Pos.z == Config.Budowa[index].z then
    return k
  end
end
end
...
Citizen.CreateThread(function()
  ...
  local ped =  CreatePed(1, 0xC5FEFADE, 889.5, -881.01, 25.10, 143.35, false, true)
    SetEntityHeading(ped, 143.35)
